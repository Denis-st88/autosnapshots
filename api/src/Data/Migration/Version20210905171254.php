 ...
 */
final class Version20210905171254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auth_users (id UUID NOT NULL, email VARCHAR(255) NOT NULL, status VARCHAR(16) NOT NULL, password_hash VARCHAR(255) DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, new_email VARCHAR(255) DEFAULT NULL, sign_up_confirm_token_value VARCHAR(255) DEFAULT NULL, sign_up_confirm_token_expires DATE DEFAULT NULL, password_reset_token_value VARCHAR(255) DEFAULT NULL, password_reset_token_expires DATE DEFAULT NULL, new_email_token_value VARCHAR(255) DEFAULT NULL, new_email_token_expires DATE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN auth_users.sign_up_confirm_token_expires IS \'(DC2Type:date_immutable)\'');
